...
import com.alien.config.interceptor.RestTemplateInterceptor;
...
public class MyConfig {
	...
	@Bean
	private OAuth2AuthorizedClientManager manager(ClientRegistrationRepository clientRegistrationRepository2,
